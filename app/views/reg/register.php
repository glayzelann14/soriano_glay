...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
  <section class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg border border-gray-200">
    ...
    <form method="POST" action="<?= site_url('reg/registerAuth'); ?>" class="space-y-5">
    ...
    <div class="text-center mt-5">
      <p class="text-sm text-gray-600">
        ...
        <a href="<?= site_url('reg/login'); ?>" class="font-medium text-blue-600 hover:underline">Login here</a>
      </p>
    </div>
  </section>
